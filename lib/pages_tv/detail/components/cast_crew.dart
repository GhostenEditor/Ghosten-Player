          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (mediaCast.scraper.type == ScraperType.tmdb) const _IMDBTag() else const _NfoTag(),
              ],
            ),
          ),
        ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (mediaCrew.scraper.type == ScraperType.tmdb) const _IMDBTag() else const _NfoTag(),
              ],
            ),
          ),
        ],
