...
const defaultIPTVUrl = String.fromEnvironment('DEFAULT_IPTV_URL');
const updateUrl = 'https://api.github.com/repos/$repoAuthor/$repoName/releases/latest';
const ua = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.75 Safari/537.36';
