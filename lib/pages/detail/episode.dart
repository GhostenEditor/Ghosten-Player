...
class _EpisodeDetailState extends State<EpisodeDetail> with ActionMixin<EpisodeDetail>, RouteAware {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => TVEpisodeCubit(widget.tvEpisodeId,
          widget.initialData != null ? AsyncSnapshot.withData(ConnectionState.waiting, widget.initialData!) : const AsyncSnapshot.waiting()),
      child: BlocBuilder<TVEpisodeCubit, AsyncSnapshot<TVEpisode>?>(builder: (context, snapshot) {
