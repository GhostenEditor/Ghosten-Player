...
class TVPlaceholder extends StatelessWidget {
  const TVPlaceholder({super.key, this.item});
  ...
  Widget build(BuildContext context) {
    return ThemeBuilder(item?.themeColor,
        builder: (context) => PlayerScaffold(
              playerControls: LayoutBuilder(builder: (context, constraints) {
                              ...
                              return GPlaceholder(
                                child: IgnorePointer(
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      const GPlaceholderImage(padding: EdgeInsets.only(right: 16), width: 100, height: 150),
                                      Expanded(
                                          child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        spacing: 7,
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView.separated(
                                ...
                                itemCount: 10,
                                itemBuilder: (context, index) => const ImageCardPlaceholder(width: 160, height: 90),
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView.separated(
                                  ...
                                  itemCount: 5,
                                  itemBuilder: (BuildContext context, int index) => const GPlaceholderRect(width: 48, height: 12)),
                            ),
                          ],
                        ),
                      ),
