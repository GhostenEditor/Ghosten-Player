                          ...
                          children: [
                            if (item?.poster != null)
                              Padding(
                                ...
                                child: AsyncImage(item!.poster!, width: 160, radius: BorderRadius.circular(4), viewable: true),
                              ),
                      ...
                      : GPlaceholder(
                          child: IgnorePointer(
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const GPlaceholderImage(padding: EdgeInsets.only(right: 16), width: 160, height: 90),
                                Expanded(
                                    child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  spacing: 7,
