                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ImageCard(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          if (ca.role != null && ca.role!.isNotEmpty) Text('${AppLocalizations.of(context)!.actAs} ${ca.role}'),
                          if (ca.episodeCount != null && ca.episodeCount! > 0) Text('${ca.episodeCount}集'),
                        ],
                      ),
                      onTap: () => navigateTo(context, SearchPage(activeTab: type == MediaType.movie ? 1 : 0, selectedCast: [ca])),
                    );
                  },
                ),
              ),
