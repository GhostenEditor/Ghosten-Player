...
class _LiveListPageState extends State<LiveListPage> {
  ...
  void _showBottomSheet<T>({
    ...
    final constraints = BoxConstraints(maxHeight: (Scaffold.of(context).context.findRenderObject()! as RenderBox).size.height + 104);
    showBottomSheet(
      context: context,
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                trailing: item == widget.controller.currentItem ? PlayingIcon(color: Theme.of(context).colorScheme.primary) : null,
