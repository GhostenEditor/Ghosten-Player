            ...
            child: Scaffold(
              ...
              body: Stack(
                ...
                children: [
                  ...
                  ListenableBuilder(
                    listenable: _controller.status,
                    builder: (context, child) => _controller.status.value == PlayerStatus.buffering ? child! : const SizedBox(),
                    child: Center(
                        child: ListenableBuilder(
                            listenable: _controller.networkSpeed,
                            builder: (context, _) => Text(_controller.networkSpeed.value.toNetworkSpeed(), style: Theme.of(context).textTheme.labelLarge))),
                  ),
                  Align(
              ...
              ListenableBuilder(
                  ...
                  builder: (context, _) {
                    return switch (_controller.status.value) {
                      PlayerStatus.playing => IconButton(onPressed: _controller.pause, icon: const Icon(Icons.pause_rounded)),
